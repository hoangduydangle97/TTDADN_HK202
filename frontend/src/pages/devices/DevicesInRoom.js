        ...
        devices.map((device) => {
          ...
          switch (Number.parseInt(device.type)) {
            case DEVICE_TYPE.TEMPERATURE_SENSOR:
              ...
              return (
                <div key={device.id} className={classes.Column}>
                  <TemperatureWidget feed={device.feed} id={deviceId} />
                </div>
              );
            case DEVICE_TYPE.GAS_SENSOR:
              ...
              return (
                <div key={device.id} className={classes.Column}>
                  <GasWidget feed={device.feed} id={deviceId} />
                </div>
              );
            case DEVICE_TYPE.LIGHT:
              ...
              return (
                <div key={device.id} className={classes.Column}>
                  <LightWidget feed={device.feed} id={deviceId} />
                </div>
              );
            case DEVICE_TYPE.WATER_PUMP:
              ...
              return (
                <div key={device.id} className={classes.Column}>
                  <WaterPumpWidget feed={device.feed} id={deviceId} />
                </div>
              );
